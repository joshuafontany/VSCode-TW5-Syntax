...
test('a ruling may name the one reader it explains', () => {
  ...
  assert.ok(isExpected(rules, 'dir/a.tw', 'markup.bold.tiddlywiki5', undefined, '5.4.1'));
  assert.ok(!isExpected(rules, 'dir/a.tw', 'markup.bold.tiddlywiki5', undefined, '5.5.0-prerelease'),
